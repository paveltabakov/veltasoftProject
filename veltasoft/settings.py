"""
Django settings for veltasoft project.
...
SECRET_KEY = 'e+2f%0=#@d)^06%8fvz+69glq@^2&60_9ija8hf1b)6@i@v08o'
...
#After we create a new application, here is the place to tell django to use it!
...
WSGI_APPLICATION = 'veltasoft.wsgi.application'
